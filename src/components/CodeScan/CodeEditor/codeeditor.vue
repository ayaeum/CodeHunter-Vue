<template>
  <div v-bind="fullScreenParentProps">
    ...
    <div class="code-editor-cust full-screen-child" disabled="true">
      <textarea ref="textarea"  aria-readonly="true" ></textarea>
    ...
    watch: {
      value: {
        handler(newVal,oldVal) {
          ...
          // this.coder.markText({line:0, ch: 0}, {line: 50, ch:0}, {className: "null"});
        }
      },
      fullCoder:{
        handler(value) {
      ...
      hightline: {
        handler(newVal) {
          ...
          //   this.hasCode=false
          // }
          this.coder.markClean();
          for(var i=0;i<this.hightline.length;i++){
            this.coder.markText({line:this.hightline[i], ch: 0}, {line: this.hightline[i]+1, ch:0}, {className: "errorHighlight"});
          }
        }
      },
      language: {
