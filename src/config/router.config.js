...
import TaskList from "../views/codescan/TaskList";
...
export const constantRouterMap = [
...

  {
    ...
    path: '/codescan',
    component: TabLayout,
    redirect: '/views/codescan',
    children: [
      {
        path: 'TaskList',
        name: 'tasklist',
        meta: { title: '任务列表' },
        component: () => import(/* webpackChunkName: "TaskList" */ '@/views/codescan/TaskList')
      }
    ]
  },

  {
    path: '/codescan',
    component: TabLayout,
    redirect: '/codescan/codescanpage',
    children: [
      {
        path: 'codescanpage',
        name: 'codescanpage',
        beforeEnter: (to, from, next) => {
          router.app.$store.replaceState(Object.assign({}, router.app.$store.state,JSON.parse(sessionStorage.getItem("store"))))
            to.meta.title = router.app.$store.state.taskName;
            next()
        },
        component: () => import('@/views/codescan/codescanpage')
      }
    ]
  },
    ...
    children: [
      {
        ...
        //设置Tab的标签名
        beforeEnter: (to, from, next) => {
          // to.meta.title = JSON.parse(sessionStorage.getItem("task")).taskName;
          to.meta.title = "扫描结果";
          next()
        },
        component: () => import('@/views/codescan/DetailPage')
      }
    ]
  },
]
